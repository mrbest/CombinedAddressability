...
sc <- sparkInit()
load_spark_parquet("August28FPDS.prq/")
...
write_csv(gsa_addressability_table, paste0("gsa_addressablility_table",Sys.Date(),".csv")

bic_markets <- process_bic_contracts()
write_csv(bic_addressability_table, paste0("bic_addressability",Sys.Date(),".csv")
